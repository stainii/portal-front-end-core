...
describe('ReportService', () => {
    ...
    it('should assemble a report when there are no tasks', inject([ReportService], (service: ReportService) => {
    ...
    it('should assemble a report when there are only late tasks', inject([ReportService], (service: ReportService) => {
    ...
    it('should assemble a report when there are only very late tasks', inject([ReportService], (service: ReportService) => {
    ...
    it('should assemble a report when there are both late and very late tasks', inject([ReportService], (service: ReportService) => {
