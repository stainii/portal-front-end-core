...
describe('taskComparator', () => {
    ...
    it('should put an urgent task before a non-urgent task', () => {
        ...
        task1.dueDateTime = moment().subtract(1, "day").toDate();

        let task2 = new Task();
        task2.importance = Importance.NOT_SO_IMPORTANT;
        task2.dueDateTime = moment().subtract(5, "day").toDate();
    ...
    it('should put an important task before a non-important task', () => {
        ...
        task3.dueDateTime = moment().subtract(1, "day").toDate();
    ...
    it('should put an non-urgent but important task before a urgent but non-important task', () => {
        ...
        task1.dueDateTime = moment().subtract(10, "day").toDate();
    ...
    it('should put an overdue bu non-important task before an important task that is not urgent at all', () => {
        let task1 = new Task();
        task1.importance = Importance.NOT_SO_IMPORTANT;
        ...
        let task2 = new Task();
        task2.importance = Importance.VERY_IMPORTANT;
        task2.dueDateTime = moment().subtract(2, "day").toDate();
